...
namespace SQL_ADO.NET_EMPLOYEE
{
    class EmployeeR
    {
        public static string connectionString = @"Data Source=DESKTOP-GJ03P1S;Initial Catalog=PayRoll;Integrated Security=True";
        ...
        public void GetAllEmployee()
        {
            try
            {
                Emp_model employeeModel = new Emp_model();
        ...
        public bool AddEmployee(Emp_model model)
        {
            try
            {
                using (this.connection)
